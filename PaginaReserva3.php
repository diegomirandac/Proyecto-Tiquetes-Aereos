...
<!--  (codigoInicio) -->
 ...
 <title>Venta de Pasajes</title>
    ...
    <body>
        ...
        <h2 align="center">Asientos Primera Clase</h2>
        <h3 align="center">Boeing 737 </h3>
        <table border="10">
            ...
            <tr>
                ...
                <td align="center">↕</td>
                <td><button style="background:purple">A/8</button></td>
                <td><button style="background:purple">A/9</button></td>
                <td><button style="background:purple">A/10</button></td>
            </tr>
            <tr>
             <td align="center" colspan="5" rowspan="1">Pasillo / Clase Economica</td>
             <td align="center" colspan="3" rowspan="1">Pasillo / Clase ejecutiva</td>
             <td align="center" colspan="1" rowspan="1">Pasillo / Entrada</td>
             <td align="center" colspan="3" rowspan="1">Pasillo / Primera Clase</td>
             <td>Cabina/Puerta</td>
            ...
            <tr>
                ...
                <td align="center">↕</td>
                <td><button style="background:purple">B/8</button></td>
                <td><button style="background:purple">B/9</button></td>
                <td><button style="background:purple">B/10</button></td>
                <td>✈Piloto✈</td>
            </tr>
            <tr>
                <td></td>
                <td><button>C/1</button></td>
                <td><button>C/2</button></td>
                <td><button>C/3</button></td>
                <td><button>C/4</button></td>
                <td align="center">↕</td>
                <td><button style="background:green">C/5</button></td>
                <td><button style="background:green">C/6</button></td>
                <td><button style="background:green">C/7</button></td>
                <td align="center">↕</td>
                <td><button style="background:purple"">C/8</button></td>
                <td><button style="background:purple">C/9</button></td>
                <td><button style="background:purple">C/10</button></td>
                <td>✈Pitolo✈</td>
            </tr>
            <tr>
              <td align="center" colspan="5" rowspan="1">Pasillo / Clase Economica</td>
            ...
            <tr>
                <td></td>
                <td><button>D/1</button></td>
                <td><button>D/2</button></td>
                <td><button>D/3</button></td>
                <td><button>D/4</button></td>
                <td><button style="background:green">D/5</button></td>
                <td><button style="background:green">D/6</button></td>
                <td><button style="background:green">D/7</button></td>
                <td align="center">↕</td>
                <td><button style="background:purple">D/8</button></td>
                <td><button style="background:purple">D/9</button></td>
                <td><button style="background:purple">D/10</button></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
       ...
       <form align="center" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            ...
            <input type="hidden" name="item_name" value="Clase Primera ">
            <input type="hidden" name="item_name" value="Asiento /">
            <input type="hidden" name="return" value="http://localhost/UIA-Progra03-Lab01/public_html/factura2.php">
