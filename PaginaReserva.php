...
<!--  (codigoInicio) -->
 ...
 <title>Venta de Pasjes</title>
    </head>
    <body>
        <h1 align="center">Venta de Tiquetes</h1>
        <h2 align="center">Asientos</h2>
        <table border="10">
            ...
            <tr>
                ...
                <td><button>A/5</button></td>
                <td><button>A/6</button></td>
                <td><button>A/7</button></td>
                <td align="center">↕</td>
                <td><button>A/8</button></td>
                <td><button>A/9</button></td>
                <td><button>A/10</button></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><button>B/7</button></td>
                <td align="center">↕</td>
                <td><button>B/8</button></td>
                <td><button>B/9</button></td>
                <td><button>B/10</button></td>
                <td>✈Piloto✈</td>
            </tr>
            <tr>
                <td></td>
                ...
                <td align="center">↕</td>
                <td><button>C/5</button></td>
                <td><button>C/6</button></td>
                <td><button>C/7</button></td>
                <td align="center">↕</td>
                <td><button>C/8</button></td>
                <td><button>C/9</button></td>
                <td><button>C/10</button></td>
                <td>✈Pitolo✈</td>
            </tr>
            <tr>
              <td align="center" colspan="5" rowspan="1">Pasillo / Clase Economica</td>
            ...
            <tr>
                ...
                <td><button>D/5</button></td>
                <td><button>D/6</button></td>
                <td><button>D/7</button></td>
                <td align="center">↕</td>
                <td><button>D/8</button></td>
                <td><button>D/9</button></td>
                <td><button>D/10</button></td>
            </tr>
            <tr>
                <td></td>
                <td></td>
        ...
        <br><br>
        <p align="center">
            DNI: <input type="text" id="dniBuscar">
        ...
        <p align="center">Apellido: <input type="text" id="apellido"required ></p>
        ...
        <hr>
        <p align="center"><input type="button" value="Lista" id="btnListar"></p>
        <div id="listar"></div>
